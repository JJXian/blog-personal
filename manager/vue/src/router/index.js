...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'search', name: 'Search', meta: { name: '搜索博客' }, component: () => import('../views/front/Search') },
      { path: 'activity', name: 'Activity', meta: { name: '活动信息' }, component: () => import('../views/front/Activity') },
